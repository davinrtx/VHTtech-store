...
/*************************************************
## Machic Custom 404 Page
*************************************************/ 
if ( ! function_exists( 'machic_custom_404_page' ) ) {
	function machic_custom_404_page( $template ) {
		global $wp_query;
		$custom_404 = get_theme_mod('machic_404_page');
	...
	add_filter( '404_template', 'machic_custom_404_page', 999 );
}
