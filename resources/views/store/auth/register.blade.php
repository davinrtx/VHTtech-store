...
@section('title', 'Crear cuenta — VHTtech Store')

@section('extra_styles')
    /* AUTH PAGES */
    .auth-section{padding:3.75rem 0;min-height:70vh;display:flex;align-items:center}
    .auth-card{max-width:500px;margin:0 auto;width:100%;background:#fff;border:1px solid var(--color-theme-border);border-radius:var(--border-radius);padding:2.5rem;box-shadow:0 2px 12px rgba(0,0,0,.04)}
    ...
    .auth-card .row-2{display:grid;grid-template-columns:1fr 1fr;gap:1rem}
    .auth-card .form-row{display:flex;align-items:center;margin-bottom:1.5rem}
    ...
    .auth-card .terms-text{font-size:.75rem;color:var(--color-text-light);text-align:center;margin-top:1rem;line-height:1.5}
    .auth-card .terms-text a{color:var(--color-link);text-decoration:underline}
